    ...
    <div class="col-xs-12" >
        <div class="panel panel-default" >
            <div class="panel-heading">
                <h3 class="panel-title">นำเข้าข้อมูลประกัน กลุ่มผู้บริหาร</h3>
            </div>
...
<div class="col-xs-4"><a href="<?php echo base_url('public/PSUFILE/importinsurance1.csv'); ?>"><h5>[ดาวน์โหลดตัวอย่างไฟล์]</h5></a></div>
